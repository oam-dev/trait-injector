...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretNameSource) DeepCopyInto(out *SecretNameSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretNameSource.
func (in *SecretNameSource) DeepCopy() *SecretNameSource {
	if in == nil {
		return nil
	}
	out := new(SecretNameSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretSource) DeepCopyInto(out *SecretSource) {
	*out = *in
	out.SecretNameFrom = in.SecretNameFrom
}
